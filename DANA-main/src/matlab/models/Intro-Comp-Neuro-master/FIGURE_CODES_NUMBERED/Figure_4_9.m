% Figure_4_9.m
% Simulates membrane potential as a function of time, when a
% sub-thresholld current is applied to the model neuron.
%
...
%
% This code is used to produce Figure 4.9 in the textbook
...
Ie= 2.2;                % extra current density (nA/cm^2) during pulse
...
% figure(1) is Figure 4.9 in the textbook
figure(1)
clf
...
%Second panel is membrane potential versus time
...
% Label the two panels as A and B
