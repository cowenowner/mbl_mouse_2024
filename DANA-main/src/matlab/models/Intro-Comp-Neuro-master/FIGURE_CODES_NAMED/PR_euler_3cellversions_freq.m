% PR_euler_3cellversions_freq.m
%
% This model is the two-compartment model of Pinsky and Rinzel (1994)
%
% Three different levels of AHP conductance are used to demonstrate its
% effect on burst frequency.
%
% This code was used to produce Figure 8.10 in the textbook:
...
% 3 different types of cell with different AHP conductance will be
% simulated
for cell_version = 1:3
    ...
    % 3 different levels of AHP conductance are used as given below
    switch cell_version
        case 1
            G_KAHP = 0.02e-6*D_frac;      % Potassium conductance to generate after-hyperpolarization
        case 2
    ...
    figure(1)
    subplot('Position',[0.18 1.02-0.31*cell_version 0.8 0.24])
    plot(t,VS*1000,'k')
    hold on
    axis([0 2 -85 50])
    ylabel('V_S (mV)')
...
annotation('textbox',[0.00 0.68 0.02 0.02],'LineStyle','none', ...
    'FontSize',16,'FontWeight','Bold','String','B')
annotation('textbox',[0.00 0.37 0.02 0.02],'LineStyle','none', ...
