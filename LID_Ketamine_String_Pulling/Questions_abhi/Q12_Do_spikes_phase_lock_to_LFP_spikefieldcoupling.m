function OUT = Q12_Do_spikes_phase_lock_to_LFP_spikefieldcoupling()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                 % lock.
%                 L(:,iFreq) = filtfilt(F{iFreq},LFP.LFP(ix1:ix2));
%                 
...
% 
%         [PhC,phinfo] = SPEC_spike_field_coupling(TS,[LFP.t_uS(ix1:ix2), L],[8 22 50 84 150],'thresh_prctile_of_power',80);
