...
signal_heatMapFolderPath = "C:\Users\hp\Desktop\PhD Stuff\MvdM Rotation\Data\SocialDA\Probe Test\Probe Signal Heat Maps";
time_heatMapFolderPath = "C:\Users\hp\Desktop\PhD Stuff\MvdM Rotation\Data\SocialDA\Probe Test\Probe Time Heat Maps";
...
for fileIdx = 1:length(matFiles)
    ...
    %Bin Position values to the nearest whole number
    pos_data(:, 2:3) = round(pos_data(:, 2:3));
    
    % Create signal heat map
    heatMap = accumarray(pos_data(:, 2:3), signal_data, [], @mean);

    % Create time heat map 
    heatMap_time = accumarray(pos_data(:, 2:3), signal_time, []);
    ...
    nanColor = 9999999; % Choose a unique placeholder value
    ...
    % Saving raw heatmaps
    outputFolder = 'C:\Users\hp\Desktop\PhD Stuff\MvdM Rotation\Data\SocialDA\Probe Test\Probe Signal Heat Maps';
    outputFolder_time = "C:\Users\hp\Desktop\PhD Stuff\MvdM Rotation\Data\SocialDA\Probe Test\Probe Time Heat Maps";
