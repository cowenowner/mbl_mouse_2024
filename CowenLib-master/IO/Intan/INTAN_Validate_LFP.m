function INTAN_Validate_LFP(LFP_Time_Multiplier,SAVE_PATH)
...
%         lfp(BADIX) = nan;
        ...
        for iEvt = 2:2 %length(ET)
            ...
            count = count + 1;
                ...
                lfp_w = ['PETH_W' num2str(iLFP+lfpRow)];
                PETH_W = ans;
...
for iLFP_Analysis = 1:length(pethfiles)
    seshfile = load(pethfiles{iLFP_Analysis}); %loads the file
    
    iPeth = iLFP_Analysis+lfpRow;
