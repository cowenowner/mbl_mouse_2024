...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LFP_file   = 'amp-B-026.dat'; % remeber - INtan starts at 0, not 1
Spike_file = 'amp-B-026.dat'; % put in a file if you think that there are spikes on that channel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LFP_sFreq = 1000; % the downsampled LFP sampling frequency. If you want to see spikes, then make this near sFreq.
sec_before = 1;   % time before the peri-event response
sec_after = 1.5;  % time after the peri-event response
thresh_spk_std = 3; % the standard deviation to detect spikes.
