function OUT = read_Intan_RHD2000_file_cowen(path,file)
% COWEN modified to allow command line input and output.
% the original is so stupid - does not allow inputs or outputs: WTF! It
% forces GUI as well.
