function [out_fname, in_fname, status,cmdout] = NPXL_Process_LF_With_CatGT(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
PRM_CATGT_PARAMS =  '-g=0 -t=0 -prb_fld -t_miss_ok -ni -lf -prb=0 -xd=0,0,384,6,500'; % just extract the ni data
...
% 
d = dir(fullfile(DATA_DIR,'*0.imec0.lf.bin'));
if isempty(d)
