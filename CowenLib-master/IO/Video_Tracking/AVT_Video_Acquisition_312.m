...
function AVT_Video_Acquisition_312()
% Initialize Camera
imaqreset;
...
trackEnabled{2} = 'on'; %Green channel tracking enabled
...
DEFAULT_THRESH(1) = 0.16; % Default threshold for red detection
DEFAULT_THRESH(2) = 0.09; % Default threshold for green detection
