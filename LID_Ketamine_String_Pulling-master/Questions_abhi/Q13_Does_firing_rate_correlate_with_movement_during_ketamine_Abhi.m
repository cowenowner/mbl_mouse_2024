function OUT = Q13_Does_firing_rate_correlate_with_movement_during_ketamine_Abhi()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Abhi 2022
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Define variables.
...
% 
% [mn_AC, ci_AC]= normci(squeeze(norm_AC(:,:,4)));
% 
% figure
% plot_confidence_intervals(AC_x_ms, mn_AC, ci_AC, clrs(1,:))
% hold on
% plot_confidence_intervals(AC_x_ms, mn_AC, ci_AC, clrs(4,:))
