function OUT = Q15_Relationship_ketamine_boardbandgamma_IMUspeed_Abhi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Abhi 2022
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Define variables.
...
OUT.ket_gamma_filt = ket_gamma_filt;
...
if any(E.EventID == 'KetInjectionStart') 
        ...
        intervals_around_evt_min =  [-55 -35; -25 -5; 2 12; 17 27];
...
elseif any(E.EventID == 'LDOPAInjectionStart')
        ...
        intervals_around_evt_min =  [-25 -5; 25 55; 65 75; 80 90];
...
F = SPEC_create_filters(ket_gamma_filt,LFP.sFreq);
