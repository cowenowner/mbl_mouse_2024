function [out_fname, in_fname, status,cmdout] = NPXL_Process_LF_With_CatGT_NP2(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cowen 2022
% SS 2023 edits for NP2 Runs both AP and LFP
...
PRM_CATGT_PARAMS =  '-g=0 -t=0 -prb_fld -t_miss_ok -ap -lf -prb=0 -gbldmx -apfilter=butter,12,300,9000 -lffilter=butter,12,0,500 -xd=0,0,384,6,500'; 
...
d = dir(fullfile(DATA_DIR,'*tcat.*.lf.bin'));
