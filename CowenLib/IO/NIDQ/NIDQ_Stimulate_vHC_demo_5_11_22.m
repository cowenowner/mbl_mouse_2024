...
PRM.inter_burst_interval_ms = 2.5;
PRM.time_between_bursts_sec = 2; % for experiment should be 2s
PRM.n_trials = 30;
PRM.output_voltage = 2; % Look at the purple digitimer stimulator to translate this to uA.

%%%%%%%% SIMPLE STIM EXPERIMNET...
pulse_sequence_sec = 0:PRM.inter_burst_interval_ms/1000:(1 + PRM.n_pulses_per_burst*PRM.inter_burst_interval_ms/1000);
...
LV.stim_files_path = 'C:\Users\CowenLab\Documents\GitHub\DANA\WCCV';
LV.stim_file = [];
