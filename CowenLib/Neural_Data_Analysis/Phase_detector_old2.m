...
% cowen - this code is embarrasing - created when I knew nothing. Coudl be
% replaced by a hilbert + angle() and 1 line probably.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for iC = 1:length(S)
    ...
    for ii = 1:length(s)
        % Find closest value.
        %[minval, idx] = min(abs(ThetaPhaseTimes(:,1) - s(ii)));
