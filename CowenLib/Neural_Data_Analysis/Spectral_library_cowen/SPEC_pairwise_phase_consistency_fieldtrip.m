% Adapted from fieldtrip: THis is rediculously opaque.
%
% NOTE: pxy = cpsd(x,y) estimates the cross power spectral density (CPSD) of two discrete-time signals, x and y, using Welch’s averaged, modified periodogram method of spectral estimation.
