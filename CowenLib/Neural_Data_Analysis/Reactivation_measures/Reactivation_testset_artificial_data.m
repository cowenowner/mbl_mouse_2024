function OUT = Reactivation_testset_artificial_data(RCT, nReps)
...
if nargin < 1 || isempty(RCT.RCT)
    ...
    RCT.n_neurons = 40; % if empty, then this is determined by the dataset that is loaded.
...
% Load  data that will be used to create the reactivated sequences.
mins_of_data = 30;
F = Izhikevich_model_neurons(mins_of_data*60,80,20,'low_firing_rate',[]);
